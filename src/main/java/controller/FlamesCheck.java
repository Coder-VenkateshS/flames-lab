...
public class FlamesCheck extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)	throws ServletException, IOException {
		...
		System.out.println("Into the servlet part");
		 ...
		 // Uncomment the below code to test your output 
		  ...
		  rd.forward(request, response);
			  ...
			  RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/affection.jsp"); rd.forward(request, response);
